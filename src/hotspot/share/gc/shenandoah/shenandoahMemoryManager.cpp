...
ShenandoahYoungGenMemoryManager::ShenandoahYoungGenMemoryManager(ShenandoahHeap* heap) :
        ShenandoahMemoryManager(heap, "Shenandoah Young Gen", "end of young generation gollection") {}

ShenandoahOldGenMemoryManager::ShenandoahOldGenMemoryManager(ShenandoahHeap* heap) :
        ShenandoahMemoryManager(heap, "Shenandoah Old Gen", "end of old generation collection") {}
