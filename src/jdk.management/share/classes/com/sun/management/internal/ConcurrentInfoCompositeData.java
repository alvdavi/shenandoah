...
public class ConcurrentInfoCompositeData extends LazyCompositeData implements java.io.Serializable {
    ...
    protected CompositeData getCompositeData() {
        ...
        concurrentInfoItemValues = new Object[] {
            ...
            concurrentInfo.getStartTimeMillis(),
            concurrentInfo.getStartTimeSeconds(),
            concurrentInfo.getEndTimeNanos(),
            concurrentInfo.getEndTimeMillis(),
            concurrentInfo.getEndTimeSeconds(),
            concurrentInfo.getDurationNanos(),
            concurrentInfo.getDurationMillis(),
            concurrentInfo.getDurationSeconds(),
            concurrentInfo.getPhaseName(),
    ...
    public static String getPhaseName(CompositeData cd) {
        return getString(cd, PHASE_NAME);
    }
